...
const Footer = () => {
  return (
    ...
    //     </nav>
    //     <aside>
    //       <p>Copyright © 2024 - All right reserved by Book Store Pvt Ltd</p>
    //     </aside>
    //   </footer>
    // </div>
  <section class="relative overflow-hidden bg-slate-800 py-8 mt-20">
    {/* you can remove the padding */}
  <div class="container relative z-10 mx-auto px-4 p-7"> 
    <div class="-m-8 flex flex-wrap items-center justify-between">
      <div class="w-auto p-8">
        <a href="#">
          <div class="inline-flex items-center">
          <span class="ml-4 text-lg font-bold">Book Store.</span>
          </div>
        </a>
      </div>
      <div class="w-auto p-8">
        <ul class="-m-5 flex flex-wrap items-center">
          <li class="p-5">
            <a class="font-medium text-sm text-white " href="#">
              Privacy Policy
            </a>
          </li>
          <li class="p-5">
