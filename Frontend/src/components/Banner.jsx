        ...
        <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
            {/* <div className="mt-8 flex max-w-max items-center space-x-2 rounded-full bg-gray-100 p-1 text-black dark:bg-slate-700 dark:text-white">
              ...
              <p className="text-sm font-medium">Your's Book&rarr;</p>
            </div> */}
            <h1 className="mt-8 text-4xl font-bold tracking-tight text-black md:text-4xl lg:text-6xl dark:text-white">
              People who care about <span className="text-[#407BFF]">your growth</span>
            </h1>
            <p className="mt-8 md:text-lg  text-md text-md text-gray-700 dark:text-white">
