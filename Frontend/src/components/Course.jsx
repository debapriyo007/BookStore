    ...
    <>
      <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 '>
          <div className='items-center justify-center text-center'>
            <h1 className='pt-44 text-2xl font-bold md:text-4xl'>We're delighted to have <span className='text-[#407BFF]'>you here!</span></h1>
            ...
            <Link to={'/'}>
            <button  className="mt-6 btn bg-[#407BFF] text-white hover:bg-[#6495fe]">Back to Home</button>
            </Link>
          </div>
